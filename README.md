### **IMPORTANT: PLEASE DOWNLOAD [PsExec](https://learn.microsoft.com/sysinternals/downloads/psexec) AND PUT IT INTO `script` FOLDER FIRST!** 
### **重要: 请先下载微软 [PsExec](https://learn.microsoft.com/sysinternals/downloads/psexec) 并将它放到 `scripts` 文件夹下！** 
